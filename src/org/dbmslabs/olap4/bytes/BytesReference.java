...
public interface BytesReference extends Comparable<BytesReference>, ToXContentFragment {
    ...
    static BytesReference bytes(XContentBuilder xContentBuilder) {
        ...
        if (stream instanceof ByteArrayOutputStream) {
            ...
            throw new RuntimeException("FIXME unsupported");
    ...
    /**
     * Returns the integer read from the 4 org.dbmslabs.olap4.bytes (BE) starting at the given index.
     */
    ...
    /**
     * Slice the org.dbmslabs.olap4.bytes from the {@code from} index up to {@code length}.
     */
    ...
    /**
     * Writes the org.dbmslabs.olap4.bytes directly to the output stream.
     */
    void writeTo(OutputStream os) throws IOException;

    /**
     * Interprets the referenced org.dbmslabs.olap4.bytes as UTF8 org.dbmslabs.olap4.bytes, returning the resulting string
     */
    String utf8ToString();
